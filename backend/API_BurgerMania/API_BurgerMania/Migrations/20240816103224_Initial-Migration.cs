    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BurgerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BurgerName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    BurgerImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BurgerCategoriesJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Burgers", x => x.BurgerId);
                    table.ForeignKey(
                        name: "FK_Burgers_Users_UserId",
                        column: x => x.UserId,
